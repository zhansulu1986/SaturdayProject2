...
public class TestCase2_SelectableButton2 extends UtilityClass {
    public static void main(String[] args) throws InterruptedException {


        /*
        Validate selecting multiple items with ctrl/cmd button
        ...
        Click on Item 1 on the selectable list;

        Click on Item 2 on the selectable list;

        Click on Item 3 on the selectable list;

        Release ctrl/cmd button;

        After selecting Item 1, 2 and 3 with ctrl/cmd button, you should see Item 1, 2 and 3 are highlighted
         */
